...
## O co jde?
**Slevobot** je Discord bot napsaný v **Pythonu** jako můj testovací projekt, sloužící k naučení Pythonu či funnkcí Gitu.
...
## Spuštění
Je potřeba vytvořit `.env` soubor a do něj vložit svůj **Discord API token**.
```
